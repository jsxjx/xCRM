$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', '/crmstatic/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', '/crmstatic/css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('.datatable').dataTable({
      ...
      "sPaginationType": "bootstrap",
       "aaSorting":[],
      "oLanguage": {"sLengthMenu": "每页 _MENU_ 条记录",
        "oPaginate": {
           "sFirst": "首页",
           "sLast": "末页",
           "sNext": "下一页",
        ...
        "sEmptyTable": "无记录",
        "sInfo": "共 _TOTAL_ 条记录 (_START_ ／ _END_)",
        "sInfoEmpty": "无记录",
        "sSearch": "快速搜索 _INPUT_ ",
        "sZeroRecords": "无匹配记录",
